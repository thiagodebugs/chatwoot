...
c=n d=n h=n i=n I=n l=n r=n s=n u=n w=n v=n BRANCH=singular SERVICE=web
...
function setup_ssl() {
  ...
  wget https://raw.githubusercontent.com/thiagodebugs/chatwoot/singular/deployment/nginx_chatwoot.conf
...
function upgrade() {
  ...
  git checkout singular && git pull
...
function cwctl_upgrade_check() {
    ...
    local remote_version_url="https://raw.githubusercontent.com/thiagodebugs/chatwoot/singular/VERSION_CWCTL"
