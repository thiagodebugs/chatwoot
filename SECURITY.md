Chatwave is looking forward to working with security researchers worldwide to keep Chatwave and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
If you have any questions about the process, contact security@chat.singularmodel.com.br. 
...
> Note: Please do not perform testing against Chatwave production services. Use a `self-hosted instance` to perform tests.
...
You can learn more about our triaging process [here](https://www.chat.singularmodel.com.br/docs/contributing-guide/security-reports).
...
Thank you for keeping Chatwave and our users safe. 🙇
