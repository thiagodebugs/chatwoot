...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if ChatwaveApp.enterprise?
                                 {
  ...
  enterprise_show_page_attributes = ChatwaveApp.enterprise? ? %i[limits all_features] : []
  ...
  enterprise_form_attributes = ChatwaveApp.enterprise? ? %i[limits all_features] : []
  FORM_ATTRIBUTES = (%i[
    name
    locale
    status
